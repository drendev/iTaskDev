  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Description: ${description} Start of development: ${today} Due Date of project: ${dueDate} Members: ${members} Deployment: ${deployment} Client Involvement: ${clientInvolvement} Complex Features: ${complexFeatures} Tasks: ${tasks} Quality Assurance and Testing Frequency: ${testing} Scope and Requirements stability: ${scope}`,
        },
      ],
    });
